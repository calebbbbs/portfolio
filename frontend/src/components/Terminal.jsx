...
function Terminal() {
  return (
    <>
      <div className='container mx-auto grid justify-end h-25 w-13 p-3 border-3 bg-gray-700 bg-opacity-75'>
      ...
      <div className='container mx-auto h-25 w-15 p-3 bg-gray-700 shadow-2xl drop-shadow-2x mb-24'>
