          ...
          <form className='w-full grid lg:grid-cols-2 gap-8 lg:gap-32 my-12' action='mailto:caleb.taylor.roberts@gmail.com' method='post' encType='text/plain'>
            <div className='space-y-8'>
              <div>
                ...
                <input className='w-full border border-input-border bg-input px-4 py-4 text-white' type='email' name='yourEmail'/>
              </div>
              <div>
                <label className='text-white block mb-6 text-xl font-bold'>
                  Subject
                </label>
                <input className='w-full border border-input-border bg-input px-4 py-4 text-white' type='text' name='yourSubject'/>
              </div>
              <div>
                <label className='text-white block mb-6 text-xl font-bold'>
                  Message
                </label>
                <textarea className='w-full border border-input-border bg-input text-white px-4 py-4 h-56 resize-none' name='yourMessage'></textarea>
              </div>
              <button className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-emerald-600 hover:brightness-100 duration-300 px-6 py-3 bg-input text-white font-bold' type='submit'>
                Send it!
              </button>
            </div>
