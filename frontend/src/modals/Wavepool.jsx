        ...
        <div className='rounded-lg shadow-lg bg-white dark:bg-[#758087] max-w-2xl'>
          ...
          <div className='p-6'>
            ...
            <p className='text-gray-700 dark:text-white text-base mb-6'>
              ...
              <br />
              Wavepool is a spotify companion web application designed to bring
              the native social aspect back to your spotify experience. Get a
              suggestion from a friend, drop it in your queue, and let them know
              if you liked it!
            </p>
            <button
              type='button'
